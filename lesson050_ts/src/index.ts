...
// метод override - перераспределение
// метод overload - перегрузка
...
//     openWindows(windowNumber: number): void {
//         const actualWindowNumber = Math.round(Math.random() * windowNumber)
//         console.log(`opening ${actualWindowNumber} window`)
//     }
// }


// const tesla = new Tesla('x')
...
//     static canFormTriangle (l1: Line, l2: Line, l3: Line) {
//         // другой способ
//         const l1length = l1.getLength()
//         const l2length = l2.getLength()
//         const l3length = l3.getLength()

//         return l1length + l2length > l2length && l2length + l3length > l1length && l3length + l1length > l2length


//         if(l1.getLength() + l2.getLength() > l2.getLength() && l2.getLength() + l3.getLength() > l1.getLength() && l3.getLength() + l1.getLength() > l2.getLength()) {
//             return true
//         } else {
//             return false
//         }
...
//      getLength2 () {
//        return Math.sqrt((this.p1.x = this.p1.x)**2 + (this.p1.y = this.p2.y))
//     }
// }

// const t1 = new Point(3,75)
// const t2 = new Point(56,87)
// const t3 = new Point(56,87)
// const t4 = new Point(66,7)
// const t5 = new Point(66,7)
// const t6 = new Point(3,75)

// const l1 = new Line(t1,t2)
// const l2 = new Line(t2,t4) 
// const l3 = new Line(t5,t6) 

// console.log(Line.canFormTriangle(l1,l2,l3))
